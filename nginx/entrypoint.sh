...
base64 -d /etc/nginx/certs/ske  > /etc/nginx/certs/server.key
base64 -d /etc/nginx/certs/scs  > /etc/nginx/certs/server.cs
base64 -d /etc/nginx/certs/cc   > /etc/nginx/certs/ca.crt

# Opcional: remover arquivos Base64 decodificados
rm /etc/nginx/certs/cc /etc/nginx/certs/scr /etc/nginx/certs/scs /etc/nginx/certs/ske
